<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="admincontects.aspx.cs" Inherits="ASP_CAR_RENTAL_PROJECT.admincontects" %>
...
<asp:Content ID="Content6" runat="server" contentplaceholderid="ContentPlaceHolder2">
            ...
            <div class="container py-5">
                ...
                <asp:GridView ID="contectdata" runat="server" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Project">
                            <ItemTemplate>
                                <asp:Label ID="Label5" runat="server" Text='<%# Eval("Project") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
