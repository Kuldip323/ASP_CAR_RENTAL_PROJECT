<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="blog.aspx.cs" Inherits="ASP_CAR_RENTAL_PROJECT.blog" %>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav mx-auto py-0">
                            ...
                            <a href="blog.aspx" class="nav-item nav-link active">Blog</a>
        ...
        <div class="container-fluid blog py-5">
            <div class="container py-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
                    ...
                    <p class="mb-0">Stay informed and inspired with the latest updates from Denno Travels. In our Blog & News section, you’ll find:
                    </p>
                </div>
                <div class="row g-4">
