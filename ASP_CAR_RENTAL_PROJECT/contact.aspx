<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="ASP_CAR_RENTAL_PROJECT.contact" %>
        ...
        <div class="container-fluid contact py-5">
            <div class="container py-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
                    ...
                    <p class="mb-0">We’re here to help! Reach out to Denno Travels for any questions, booking assistance, or support. Or use our Online Contact Form on the website for quick responses. Whatever you need, we’re here to make your car rental experience smooth and hassle-free!</p>
                </div>
                <div class="row g-5">
                        ...
                        <div class="row g-5">
                            <div class="col-md-6 col-lg-6 col-xl-3">
                                <div class="contact-add-item p-4">
                                    ...
                                    <div>
                                        <h4>Address</h4>
                                        <p class="mb-0">Ngong Road,Kilimani, Kenya</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="contact-add-item p-4">
                                    ...
                                    <div>
                                        <h4>Mail Us</h4>
                                        <p class="mb-0">dennisnjau@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="form-floating">
                                            ...
                                            <asp:TextBox runat="server" class="form-control" placeholder="Your Name" id="name"></asp:TextBox>
                                    ...
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="form-floating">
                                            ...
                                            <asp:TextBox runat="server" class="form-control" placeholder="Your Email" id="email"></asp:TextBox>
                                    ...
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="form-floating">
                                            ...
                                            <asp:TextBox runat="server" class="form-control" id="project" placeholder="Project"></asp:TextBox>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <asp:Button runat="server" Text="Send Message" class="btn btn-light w-100 py-3" id="sentmessage" OnClick="sentmessage_Click"></asp:Button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="col-12 col-xl-5 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="p-5 bg-light rounded">
                            <div class="bg-white rounded p-4 mb-4">
                                <h4 class="mb-3">Our Branch 01 Branch 01</h4>
                                <div class="d-flex align-items-center flex-shrink-0 mb-3">
                                    <p class="mb-0 text-dark me-2">Address:</p><i class="fas fa-map-marker-alt text-primary me-2"></i><p class="mb-0">Ngong Road,Kilimani, Kenya</p>
                                </div>
                                <div class="d-flex align-items-center">
                                    <p class="mb-0 text-dark me-2">Telephone:</p><i class="fa fa-phone-alt text-primary me-2"></i><p class="mb-0">+254 724 227813</p>
                                </div>
                            </div>
                            <div class="bg-white rounded p-4 mb-4">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <a href="#"><i class="fa fa-map-marker-alt me-2"></i> Ngong Road,Kilimani, Kenya</a>
