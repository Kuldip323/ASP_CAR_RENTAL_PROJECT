<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="service.aspx.cs" Inherits="ASP_CAR_RENTAL_PROJECT.service" %>
        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
                    ...
                    <p class="mb-0">At Denno Travels, we offer a range of services designed to meet all your car rental needs
                    </p>
                </div>
                <div class="row g-4">
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item p-4">
                            ...
                            <p class="mb-0">Book your vehicle with ease over the phone. Our team is ready to assist and confirm your reservation instantly.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item p-4">
                            ...
                            <p class="mb-0">Enjoy exclusive discounts and special rates on various vehicles and rental packages, ensuring value for every journey.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item p-4">
                            ...
                            <p class="mb-0">Pick up a car in one location and drop it off in another, offering flexibility and convenience for your travel plans.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item p-4">
                            ...
                            <p class="mb-0">Travel with added peace of mind. We provide optional life insurance coverage for extra security during your rental period.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item p-4">
                            ...
                            <p class="mb-0">Need to travel long distances? Our city-to-city rental option is ideal for business or leisure trips between destinations.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item p-4">
                            ...
                            <p class="mb-0">Experience the convenience of free rides to and from our pick-up locations, making your rental experience smooth from start to finish.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid testimonial py-5">
            <div class="container py-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
                    ...
                    <p class="mb-0">Don’t just take our word for it—see what our satisfied customers have to say about their experience with Denno Travels.
                    </p>
                </div>
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                    <div class="testimonial-item">
                        ...
                        <div class="border-top rounded-bottom p-4">
                            <p class="mb-0">“Exceptional service! The car was in perfect condition, and the free pick-up and drop-off made everything so convenient. Highly recommend!”</p>
                        </div>
                    </div>
                    <div class="testimonial-item">
                        <div class="testimonial-quote"><i class="fa fa-quote-right fa-2x"></i>
                        ...
                        <div class="border-top rounded-bottom p-4">
                            <p class="mb-0">“Outstanding service! I appreciate how easy it was to book, and the customer care was exceptional. Will definitely be using them again!”</p>
                        </div>
                    </div>
                    <div class="testimonial-item">
                        <div class="testimonial-quote"><i class="fa fa-quote-right fa-2x"></i>
                        ...
                        <div class="border-top rounded-bottom p-4">
                            <p class="mb-0">“I’ve rented from several car hire companies, but this was by far the best experience. Friendly staff, great prices, and 24/7 support came in handy when I needed it.”</p>
                        </div>
                    </div>
                </div>
            </div>
