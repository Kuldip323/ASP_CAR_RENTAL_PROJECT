<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="cars.aspx.cs" Inherits="ASP_CAR_RENTAL_PROJECT.cars" %>
                        ...
                        <div class="navbar-nav mx-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0">
                                    ...
                                    <a href="cars.aspx" class="dropdown-item active">Our Cars</a>
        ...
        <div class="container-fluid categories py-5">
            <div class="container py-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
                    ...
                    <p class="mb-0">At Denno Travels, we offer a wide selection of vehicles to suit every occasion and preference.Whatever your travel needs, we have a vehicle category designed to offer comfort, reliability, and style. Choose from our diverse categories:
                    </p>
                </div>
